<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('teachers.create') }}" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-700">
                Add New Teacher
            </a>
        </div>
    </x-slot>
            ...
            <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
                <thead class="bg-blue-700 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="py-3 px-4 text-center text-white">Phone</th>
                ...
                <tbody>
                    @forelse ($teachers as $teacher)
                        <tr class="border-b border-gray-200 hover:bg-gray-50 text-center">
                            ...
                            <td class="py-2 px-4 text-gray-700">{{ $teacher->email }}</td>
                            <td class="py-2 px-4 text-gray-700">{{ $teacher->phone }}</td>
                            <td class="py-2 px-4 text-center">
                                <a href="{{ route('teachers.show', $teacher->id) }}" class="inline-block px-4 py-2 text-white bg-green-500 rounded-lg hover:bg-green-600">Detail</a>
                                <a href="{{ route('teachers.edit', $teacher->id) }}" class="inline-block px-4 py-2 ml-2 text-white bg-blue-500 rounded-lg hover:bg-blue-600">Edit</a>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="py-2 px-4 text-center text-gray-500">No teachers found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
